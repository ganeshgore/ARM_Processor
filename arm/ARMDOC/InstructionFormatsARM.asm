...
processor CPU_CAPABILITY_26BIT
...
processor CPU_CAPABILITY_A

	swp	r0,r1,[r2]
	swpb	r0,r1,[r2]

processor CPU_CAPABILITY_V3
...
processor CPU_CAPABILITY_J

	bxj	r0

processor CPU_CAPABILITY_V6
...
processor CPU_CAPABILITY_Z

	smc	0

	smi	0

processor CPU_CAPABILITY_T2
...
processor -1	;In ARM mode, UND is always encodable, it ignores the processor directive
