...
macro align {times(($ and 2)shr 1)dh 0xde00}
...
processor CPU_CAPABILITY_V5T

	bkpt	0

	blx	r0

processor CPU_CAPABILITY_V6T
...
processor CPU_CAPABILITY_ALIGN
...
processor CPU_CAPABILITY_7M + CPU_CAPABILITY_V5T
...
processor -1	;16-bit UND is always encodable, it ignores the processor directive
